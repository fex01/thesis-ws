...
# Further filter out rows where runtime is greater than 60 seconds
...
bar_width = 0.8  # Adjust as necessary for your data

# Plot average runtimes
plt.bar(average_runtimes.index.astype(str), average_runtimes, color='blue', width=bar_width)
...
# Set plot title
plt.title('Average Runtime per Test Case (> 1 minute)')

plt.tight_layout()
plt.show()

# Save the plot
plt.savefig('avg_runtime_slow_tcs.png', dpi=300, bbox_inches='tight')
